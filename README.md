...
- **RabbitMQ** - очередь сообщений (зарезервировано для будущего использования)
...
- `GET /chat/` - получение списка чатов пользователя
